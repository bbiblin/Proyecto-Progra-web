    ...
    if (String(user).length >= 5 && String(user).length <= 20) {
        ...
        if (email.search(/(@duocuc.cl)|(@gmail.com)/) !== -1) {
            if (String(pass).length >= 8) {
                ...
                document.getElementById("resultado").innerHTML = "<div class='alert alert-success w-25 mx-auto text-center'>" +
                    "Acceso concedido</div>";
            } else {
                document.getElementById("pass").style.border = "1px solid red";
                document.getElementById("resultado").innerHTML = "<div class='alert alert-danger text-center' style='width: 200px;'>" +
                    "La contraseña debe tener al menos 8 caracteres</div>";
            }
        } else {
            document.getElementById("username").style.border = "1px solid red";
            document.getElementById("pass").style.border = "1px solid red";
            document.getElementById("resultado").innerHTML = "<div class='alert alert-danger w-25 mx-auto text-center'>" +
